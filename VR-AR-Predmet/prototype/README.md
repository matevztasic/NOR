...
`index.html` je delujoča **WebXR/spletna aplikacija** (brez zunanjih knjižnic, samostojna datoteka) — teče neposredno v brskalniku, brez namestitve. Implementira jedrno mehaniko iz `/vaja-01/` (ideja) in `/vaja-02/` (scene) v pravem prvoosebnem 3D okolju:
...
## Zagon
Samo odprite `index.html` v poljubnem brskalniku (dvoklik, ali Chrome/Edge → Datoteka → Odpri) — ni potrebna nobena namestitev.
